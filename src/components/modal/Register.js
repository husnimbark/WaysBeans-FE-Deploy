      ...
      <Modal.Body className="text-dark">
        <div className=" justify-content-center">
          <div className="card-auth p-4">
            ...
            <div className="mb-3 f-1 fs-2 fw-bold text-main">Register</div>
            ...
            <Form onSubmit={(e) => handleSubmit.mutate(e)}>
              <div>
                <input
                  ...
                  className="form-control py-2 mt-4 f-2 bg-second border-main"
                />
              </div>
              <div>
                <input
              ...
              <div className="d-grid gap-2 mt-5 pb-3">
                <Button className=" button-main f-2 fw-bold text-light" type="submit" variant="light">
                  Register
                </Button>
              </div>
            </Form>
